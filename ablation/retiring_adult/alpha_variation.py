...
# alpha_multipliers = [0.001, 0.01, 0.1, 1.0, 10.0, 100.0, 1000.0, 10000.0]
...
plt.savefig('retiring_adult_uniform_alpha_sim.png', dpi=300)
pd.DataFrame({'Scale': alpha_multipliers, 'err_f': results_b, 'err_fs': results_s, 'err_fimp': results_i}).to_csv('retiring_adult_uniform_alpha_sim.csv', index=False)