...
alpha_multipliers = [1.0, 5.0, 10.0, 30, 50.0, 70, 100.0]
...
plt.title('Effect of Uniform Manipulation Costs - HELOC Dataset')
plt.legend()
...
plt.savefig('heloc_uniform_alpha_sim.png', dpi=300)
pd.DataFrame({'Scale': alpha_multipliers, 'err_f': results_b, 'err_fs': results_s, 'err_fimp': results_i}).to_csv('heloc_uniform_alpha_sim.csv', index=False)