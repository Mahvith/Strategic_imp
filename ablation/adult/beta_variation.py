...
# beta_values = [0.1, 0.5, 0.7, 1.0, 2.0, 50.0, 100.0, 1000.0, 10000.0]
...
plt.title('Effect of Varying Beta (Allowed Manipulation Cost) - Adult Dataset')
plt.legend()
...
plt.savefig('adult_beta_sim.png', dpi=300)
pd.DataFrame({
    'Beta': beta_values,
    'err_f': results_b,
    'err_fs': results_s,
    'err_fimp': results_i
}).to_csv('adult_beta_sim.csv', index=False)

print("Experiment complete. Results saved to 'adult_beta_sim.png' and 'adult_beta_sim.csv'.")