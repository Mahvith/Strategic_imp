...
# 1. DATA PREPARATION
# =============================================================================
def load_and_process_acs_income(datapath="acsincome.csv"):
...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test = load_and_process_acs_income(datapath="acsincome.csv")
    ...
    fixed_beta = 1.0
    fixed_alpha = torch.tensor([1.0, 1.0, 1.0], dtype=torch.float32, device=device)
    ...
    plt.show()
    print("Plot saved as 'sample_complexity_curves_with_variance_with_pacimp.png'.")