...
if __name__ == "__main__":
    ...
    try:
        X_train, X_test, y_train, y_test = load_and_process_acs_income('acsincome.csv')
    ...
    fixed_beta = 1.0
    # fixed_alpha = torch.tensor([100.0, 5.0, 1.0], dtype=torch.float32, device=device) ## as per paper 
    ...
    for n in tqdm(train_sizes):
        ...
        for run in range(num_runs):
            ...
            trainer_b = BayesTrainer(model_bayes, train_dl_sub, val_dl_sub, opt_b)
