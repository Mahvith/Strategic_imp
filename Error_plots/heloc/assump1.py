...
# Replace them with NaN so they don't distort the continuous plotting grid 
...
def plot_monotonicity_all(model, X_data, feature_names, save_path="heloc_all_features_monotonicity.pdf"):
    n = len(feature_names)
    cols = 5
