...
X, y = load_and_process_synthetic_data('synthetic_dataset.csv')
...
# # Load true w
# w = np.load("Imp_rate/true_w.npy")

# # Create eta model
# eta_model = EtaModel(w)
...
for name, model in models.items():
    ...
    log_experiment(name ,w,b,alpha_np,beta,n_manip,n_imp,rate, "synthetic_Imp_rate.csv")