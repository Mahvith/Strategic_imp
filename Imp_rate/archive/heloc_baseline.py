...
# ═══════════════════════════════════════════════════════════
# RUN ON HELOC DATASET (FIXED — MINIMAL CHANGES ONLY)
# ═══════════════════════════════════════════════════════════
...
# ───────── TRAIN f* ─────────
print("[HELOC] Training f*...")
fstar_heloc = train_fstar(X_train, y_train)

# Train h on f* labels
y_fstar_train = fstar_heloc.predict(X_train)

# ───────── TRAIN h ─────────
print("[HELOC] Training h model...")
