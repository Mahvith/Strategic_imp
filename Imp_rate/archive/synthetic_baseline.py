...
# ═══════════════════════════════════════════════════════════
# RUN ON SYNTHETIC DATASET (FIXED — MINIMAL CHANGES ONLY)
# ═══════════════════════════════════════════════════════════

print("\n[Synthetic] Loading data...")
...
# ───────── TRAIN f* ─────────
print("[Synthetic] Training f*...")
fstar_synthetic = train_fstar(X_train, y_train)

# Train h on f* labels
y_fstar_train = fstar_synthetic.predict(X_train)

# ───────── TRAIN h ─────────
print("[Synthetic] Training h model...")
