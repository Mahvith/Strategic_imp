...
# opt_linear = torch.optim.Adam(model_linear.parameters(), lr=0.1)
...
# opt_imp = torch.optim.Adam(model_imp_aware.parameters(), lr=0.1)
...
for name, model in models.items():
    ...
    w, b, n_manip, n_imp, rate = compute_manipulated_stats_laws(
        model,
        X_test,
        y_test,
        eta_model,
    ...
    log_experiment(name ,w,b,alpha_np,beta,n_manip,n_imp,rate, "law_school_Imp_rate.csv")