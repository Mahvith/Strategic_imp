...
# ═══════════════════════════════════════════════════════════
# RUN ON ACS INCOME DATASET (FIXED — MINIMAL CHANGES ONLY)
# ═══════════════════════════════════════════════════════════

print("\n[ACS Income] Loading data...")
X, y = load_and_process_acs_income('Imp_rate/retiring_adult_data.csv')
...
# ───────── TRAIN f* ─────────
print("[ACS Income] Training f*...")
fstar_acs_income = train_fstar(X_train, y_train)

# Train h on f* labels
y_fstar_train = fstar_acs_income.predict(X_train)

# ───────── TRAIN h ─────────
print("[ACS Income] Training h model...")
