...
# ═══════════════════════════════════════════════════════════
# 1. Synthetic DATASET LOADER & FEATURE MASKING
# ═══════════════════════════════════════════════════════════
...
def load_and_preprocess_synthetic(csv_path="synthetic_dataset.csv", random_state=42):
    """
    ...
    improvable_indices = [0, 1, 2, 3, 4, 5, 6, 7] # All features are improvable in this synthetic dataset
    ...
    return X_train, X_test, y_train, y_test, improvable_indices
...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test, improvable_features = load_and_preprocess_synthetic("synthetic_dataset.csv")
