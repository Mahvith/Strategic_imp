...
from classifiers import get_strategic_response_batch
...
def compute_manipulated_stats(model, X_test, y_test, eta_model, alpha_np, beta):
    ...
    # strategic features
    X_strat = get_strategic_response_batch(X_test, w, b, alpha_np, beta)
...
def log_experiment_from_weights(
    model_name,
    w,
    b,
    X_test,
    ...
    num_manip, num_imp, rate = compute_stats_from_weights(
        w,
        b,
        X_test,
        y_test,
