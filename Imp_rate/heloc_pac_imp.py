...
# ═══════════════════════════════════════════════════════════
# 1. HELOC DATASET LOADER & FEATURE MASKING
# ═══════════════════════════════════════════════════════════
...
def load_and_preprocess_heloc_pacimp(csv_path="heloc.csv", random_state=42):
    # Load dataset
    ...
    y = df['Target'].values
    X_df = df.drop(columns=['Target', 'RiskPerformance'])
...
if __name__ == "__main__":
    ...
    X_train, X_test, y_train, y_test, improvable_features = load_and_preprocess_heloc_pacimp("heloc.csv")
