...
# 1. Load data
X, y, feature_names = load_and_process_lawschool("law_school_clean.csv")
...
# print(feature_names) # ['decile1b', 'decile3', 'lsat', 'ugpa', 'zfygpa', 'zgpa'] 
...
# 3. Run Validation
plot_monotonicity_all(model_pipeline, X, feature_names, "lawschool_features_monotonicity.pdf")