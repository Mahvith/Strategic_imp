...
# 1. Load data
X, y, feature_names = load_and_process_heloc("Ass_valid/dataset_plots/heloc.csv")
...
# 3. Run Validation
plot_monotonicity_all(model_pipeline, X, feature_names, "Ass_valid/dataset_plots/heloc_features_monotonicity.pdf")